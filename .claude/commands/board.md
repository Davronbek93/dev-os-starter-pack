...
4. Record every state transition, blocker, and review verdict through `node board/cli.mjs` with `--actor agent:<role>`, per the recording protocol in docs/18-Board.md.
